<template>
  <div class="container">
    <button class="btn" @click="showPopup = !showPopup">
      {{ showPopup ? "隐藏" : "显示" }}播放内容
    </button>
...
export default {
  data() {
    return {
      showPopup: false,
      mediaName: 'media',
      mediaSource: '/obj_wo3DlMOGwrbDjj7DisKw_26273634012_a205_52a8_2af8_18a28fd85860e30f2065db73380912e7.flac',
